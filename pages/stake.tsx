...
import { SwitchNetworkButton } from "../components/base/buttons/switchNetworkButton";
        ...
        <Section>
            <Card className=" my-4 w-full">
                <div className="flex w-full justify-evenly">
                    ...
                    <Stat
                        ...
                        value={
                            totalStaked
                                ? ethers.utils.formatUnits(totalStaked)
                                : undefined
                        }
                        commify={true}
                        after=" ASCEND"
                    ...
                    <Stat
                        ...
                        value={
                            periodFinish
                                ? new Date(periodFinish * 1000).toDateString()
                                : undefined
                        }
                    />
                </div>
            ...
            <Card className="">
                {!active ? (
                    ...
                    <>
                        <h1 className="text-xl">Staking</h1>
                        ...
                        {isEnabled ? (
                            <>
                                ...
                                <Pill
                                    className="bg-green-500 w-11/12 "
                                    onClick={() => getReward()}
                                >
                                    Collect Earnings
                                </Pill>

      ...
      >
        ...
        >
          <g clip-path="url(#clip0_229_5)">
            <path
              d="M542.48 259.8H211.52L377 199.82L542.48 259.8Z"
              fill="url(#paint0_linear_229_5)"
            />
            <path
              d="M377 199.82V0L211.52 259.8L377 199.82Z"
              fill="url(#paint1_linear_229_5)"
            />
            <path
              d="M377 199.82V0L542.48 259.8L377 199.82Z"
              fill="url(#paint2_linear_229_5)"
            />
            <path
              d="M593.71 340.17H160.39L377 399.68L593.71 340.17Z"
              fill="url(#paint3_linear_229_5)"
            />
            <path
              d="M0 591.6L377 754V399.68L160.39 340.17L0 591.6Z"
              fill="url(#paint4_linear_229_5)"
            />
            <path
              d="M754 591.6L377 754V399.68L593.71 340.17L754 591.6Z"
              fill="url(#paint5_linear_229_5)"
            />
          </g>
          <defs>
            <linearGradient
              id="paint0_linear_229_5"
              x1="381.41"
              y1="309.22"
              x2="368.29"
              y2="162.13"

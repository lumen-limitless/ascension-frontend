...
interface AscensionStakedTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class AscensionStakedToken extends BaseContract {
  ...
  interface: AscensionStakedTokenInterface;

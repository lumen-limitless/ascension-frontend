...
interface AscensionStakingStorageInterface extends ethers.utils.Interface {
  functions: {
...
export class AscensionStakingStorage extends BaseContract {
  ...
  interface: AscensionStakingStorageInterface;

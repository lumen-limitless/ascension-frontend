...
interface AscensionGovernorInterface extends ethers.utils.Interface {
  functions: {
...
export class AscensionGovernor extends BaseContract {
  ...
  interface: AscensionGovernorInterface;

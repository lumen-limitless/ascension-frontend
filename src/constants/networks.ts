...
export const RPC: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.ArbitrumRinkeby]: 'https://arb-rinkeby.g.alchemy.com/v2/fVMS0IOOy-uC_2w1sCooihRBSbxD57NN',
  [ChainId.Arbitrum]: 'https://arb-mainnet.g.alchemy.com/v2/RU9HDzHNgDzOZceQTwS_XqB75obxlrNf',
  [ChainId.Mainnet]: 'https://eth-mainnet.alchemyapi.io/v2/UdQPMrxaFxiuNVt1SgCtPiE5sopkDOnP',
  ...
  [ChainId.Polygon]: 'https://polygon-mainnet.g.alchemy.com/v2/UYsLwfM1od6soaCTh28mO8PTg-pcKKSn',

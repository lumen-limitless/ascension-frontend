...
interface ERC20DistributorStorageInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC20DistributorStorage extends BaseContract {
  ...
  interface: ERC20DistributorStorageInterface;

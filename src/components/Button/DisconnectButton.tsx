...
export default function DisconnectButton() {
  ...
  return (
    <Button onClick={deactivate} className="px-1" title="disconnect" about="disconnect" id="disconnect">
      <svg
        viewBox="0 0 24 24"
        className="fill-current text-red text-opacity-80 hover:text-opacity-100"
        width="20px"

...
const EMPTY = {
    default:
        " bg-transparent justify-center items-center disabled:opacity-50 disabled:cursor-auto bg-opacity-80 hover:bg-opacity-100",
};
    ...
    return (
        <button
            className={classNames(
                ...
                "flex rounded disabled:cursor-not-allowed focus:outline-none disabled:opacity-40",

...
export function ReactorLogo() {
  return (
    ...
    >
      ...
      />
      <path
        d="M243.305 118.935C280.453 150.559 308.035 182.72 322.636 209.11C329.941 222.312 333.947 233.982 334.351 243.372C334.755 252.775 331.55 259.644 324.856 263.656C318.163 267.668 308.136 268.73 295.243 266.813C282.366 264.898 266.974 260.054 250.04 252.622C216.193 237.768 176.643 212.781 139.495 181.157C102.347 149.533 74.7653 117.373 60.1639 90.9822C52.859 77.7796 48.8528 66.1104 48.4492 56.7199C48.045 47.3172 51.2498 40.4479 57.9435 36.4358C64.6372 32.4237 74.6642 31.3621 87.5573 33.2791C100.433 35.1937 115.826 40.0383 132.759 47.4696C166.607 62.3238 206.157 87.3112 243.305 118.935Z"
        stroke="url(#paint1_linear_229_19)"
        strokeWidth="4"
      />
      <path
        d="M260.139 150C260.139 191.196 252.331 228.395 239.793 255.219C227.181 282.205 210.155 298 192.032 298C173.91 298 156.884 282.205 144.271 255.219C131.734 228.395 123.925 191.196 123.925 150C123.925 108.804 131.734 71.6054 144.271 44.7808C156.884 17.7948 173.91 2 192.032 2C210.155 2 227.181 17.7948 239.793 44.7808C252.331 71.6054 260.139 108.804 260.139 150Z"
      ...
      <g clipPath="url(#clip0_229_19)">
        ...
        />
        <path
          d="M225.562 170.492L188.984 186V152.166L210.01 146.483L225.562 170.492Z"

...
const navigation = {
  ...
  social: [
    ...
    },
    {
      ...
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 28 24" {...props}>
          <path
            fillRule="evenodd"
...
export default function Footer() {
  return (
    <footer className=" relative bg-dark-1000 text-center">
      <Divider />
      ...
      <span className="absolute bottom-1 right-1">DEVELOPMENT VERSION (ALPHA)</span>
    </footer>
  )
}

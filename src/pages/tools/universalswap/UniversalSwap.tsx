...
export default function UniversalSwap() {
  ...
  return (
    <div className="flex min-h-[500px] w-full flex-col gap-10 md:flex-row ">
      <Card className="flex-basis-16 flex-shrink-0 md:w-80">
        <div className="flex h-full flex-col items-center justify-evenly gap-1">
      ...
      <TradingChart dex={dex} buyToken={tokens.buyToken} sellToken={tokens.sellToken} />
    </div>
  )
}

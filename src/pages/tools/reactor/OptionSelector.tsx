...
export default function OptionSelector({
    ...
    const [argInput, setArgInput] = useState<any>();
    ...
    return (
        <>
            ...
            {event &&
                ...
                args.length < func.inputs.length && (
                    <>
                        <h1>
                            Enter argument for {func.inputs[args.length].name} (
                            {func.inputs[args.length].type})
                        </h1>

      ...
      <Section fullscreen>
        ...
        <Container maxWidth="5xl">
          ...
          >
            ...
            investment and therefore you should only invest money that you can
            afford to lose.
            <br></br>
            <br></br>
            By purchasing or interacting with this software in any form, you
            agree that Ascension Protocol, the Ascension Group developer team,
            and the Ascension DAO do not guarantee any financial gains and
            therefore cannot be held liable for any resulting financial losses.
            Ascension Protocol is experimental, open-source technology provided
            as is under the MIT license. Please do your own research before
            investing and only invest what you can afford to lose.
          </Card>
        </Container>
      </Section>
    </>

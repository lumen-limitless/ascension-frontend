...
const LegalPage: NextPage = () => {
  return (
    <>
      <NextSeo title={`Legal | Ascension Protocol`} description={`Ascension Protocol legal`} />
      <Section fullscreen>
        {' '}
        <Container maxWidth="5xl">
          ...
          >
            ...
            any of the website&apos;s content as such.
            <br></br>
            <br></br>
            ...
            that you could sustain a loss of some or all of your initial investment and therefore
            ...
            license. Please do your own research before investing and only invest what you can
            afford to lose.
          </Card>
        </Container>
      </Section>

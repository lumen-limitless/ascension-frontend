...
const StakeLegacyPage: NextPageWithLayout = () => {
  ...
  const exitConfig = usePrepareContractWrite({
    address: '0x41653518cf58C6c838d05F771711AaDD19bEC6a0',
    abi: ABI,
    functionName: 'exit',
  })
    ...
    <>
      ...
      <Section centered>
        <div className="flex flex-col items-center justify-center gap-9 px-3 text-center">
          <Logo className="h-12" />
          <h2 className="text-xl">Exit from legacy staking contract</h2>
          ...
          <WagmiTransactionButton
            ...
            name="Exit Staking"
            onTransactionSuccess={() => t('success', 'Exit Staking successful')}
...
export default StakeLegacyPage

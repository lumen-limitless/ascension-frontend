...
const HomePage: NextPage = () => {
  return (
    <>
      ...
      <div
        className="relative flex h-full min-h-screen w-full flex-col items-center justify-start text-center"
        id="features"
      >
            ...
            <Card>
              <div className="md:pb-12">
                ...
                <div className="grid grid-cols-1 gap-3  md:grid-cols-2">
                  <a
                    className="flex flex-grow justify-center gap-1 rounded bg-[#2AABEE] p-3 text-center transition hover:bg-opacity-80"
                  ...
                  <a
                    className="flex flex-grow justify-center gap-1 rounded bg-[#5865F2] p-3 text-center transition hover:bg-opacity-80"
                  ...
                  <a
                    className="flex flex-grow justify-center gap-1 rounded bg-pink p-3 text-center transition hover:bg-opacity-80"
                  ...
                  <a
                    className="flex flex-grow justify-center gap-1 rounded bg-ascend-purple p-3 text-center transition hover:bg-opacity-80"

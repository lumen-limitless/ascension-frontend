...
export default function Toast({ type, message, id }: ToastProps) {
    ...
    return (
        <>
            {type == "success" && (
                <div className="rounded-md bg-white border-l-4 border-green-800 p-4 m-3 z-40 ">
                    <div className="flex">
            ...
            {type == "info" && (
                <div className="rounded-md bg-white border-l-4 border-blue-600 p-4 m-3 z-40 ">
                    <div className="flex">
                        <div className="flex-shrink-0">
                            <Info />
                        </div>
            ...
            {type == "error" && (
                <div className="rounded-md bg-white border-l-4 border-red-800 p-4 m-3 z-50">
                    <div className="flex">
                        <div className="flex-shrink-0">
                            <svg
                        ...
                        <div className="ml-auto pl-3">
                            <div className="-mx-1.5 -my-1.5">
                                <button
                                    ...
                                    className="inline-flex  rounded-md p-1.5 text-red-500 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-50 focus:ring-red-600"
                                >
                                    <span className="sr-only">Dismiss</span>

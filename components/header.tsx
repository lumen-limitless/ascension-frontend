...
import DarkModeButton from "./base/buttons/themeButton";
...
export default function Header() {
    ...
    return (
        <header className="   flex flex-col w-full px-4 py-1 justify-between items-center  md:text-xl ">
            <div className="w-full h-full flex  items-center">
                <button onClick={toggleViewing} className={`px-2 md:hidden`}>
                    <svg
                        width="20"
                        height="20"
                        viewBox="0 0 20 20"
            ...
            {viewing ? (
                <>
                    <Modal onExit={() => toggleViewing(false)}>

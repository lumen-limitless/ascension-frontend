...
export default function Nav() {
  ...
  const balance = useAscendBalance();

  return (
    <nav className="flex  h-full w-3/6  items-center justify-center  text-white mx-8">
      <ul className="flex content-center items-center justify-evenly h-2/3 w-full h-full my-auto">
        <li
          title="Dashboard"
